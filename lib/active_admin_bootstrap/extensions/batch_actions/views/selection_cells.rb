...
ActiveAdmin::BatchActions::ResourceSelectionToggleCell.class_eval do
  prepend ActiveAdminBootstrap::Extensions::BatchActions::ResourceSelectionToggleCell
end

ActiveAdmin::BatchActions::ResourceSelectionCell.class_eval do
  prepend ActiveAdminBootstrap::Extensions::BatchActions::ResourceSelectionCell
end
