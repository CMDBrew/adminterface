---
sidebar_position: 4
description: ActiveAdmin Bootstrap Guide for Confirm Dialog Configs, Override the Defaults, and Javascript Events.
---
...
<Tabs
  ...
  ```yaml title="e.g., config/active_admin_bootstrap/admin/css_classes.yml" {2-5}
  ---
  confirm_dialog:
