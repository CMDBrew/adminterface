...
# Components
Adminterface provides a set of components that you can use throughout your application.
...
## Confirm Dialog
Confirm dialogs are popups that ask the user for confirmation when performing a specific action.
