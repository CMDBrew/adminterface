...
We've enhanced the `batch_action` feature to make it more customizable and extendable. We only list the adjustments we've made in the sections below. Please visit [ActiveAdmin] for basic usage guides.
