...
### ConfirmDialog
Adminterface uses ConfirmDialog for batch action and delete confirmations. See the guides on [BatchActions](/docs/guides/index#batch-actions) and [ConfirmDialog](/docs/guides/components#confirm-dialog) for more information.
...
### InputCounter
Adminterface uses InputCounter for text inputs. See the guides on [Customizing the Form](/docs/guides/form#text) for more information.
