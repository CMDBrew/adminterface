...
### Flatpickr
The variables are for customizing the styles for the [`:date_picker`](/docs/guides/customizing-the-form#datepicker) and [`:datetime_picker`](/docs/guides/customizing-the-form#datetimepicker) components.
...
### Trix
The variables are for customizing the styles for the [`:rich_text_area`](/docs/guides/customizing-the-form#richtextarea) component.
