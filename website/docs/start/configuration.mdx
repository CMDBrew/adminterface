...
### Flatpickr
The variables are for customizing the styles for the [`:date_picker`](/docs/guides/form#datepicker) and [`:datetime_picker`](/docs/guides/form#datetimepicker) components.
...
### Trix
The variables are for customizing the styles for the [`:rich_text_area`](/docs/guides/form#richtextarea) component.
