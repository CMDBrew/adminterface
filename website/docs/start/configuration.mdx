---
sidebar_position: 3
description: ActiveAdminBootstrap Configuration Guide for Scoping, CSS, Components, and Theme.
---
...
You can add your custom layout by adding custom CSS styles. Here is an example of creating a hamburger navigation layout.

First, create a stylesheet and add styles to the custom navigation.

```scss title="app/javascript/stylesheets/active_admin_bootstrap/layouts/_navigation_hamburger.scss"
$_header-height: 64px;
...
body.layout-navigation-hamburger {
  grid-template-areas:
    "title_bar"
    "content"
    "header";
...
@import "active_admin_bootstrap/layouts/navigation_hamburger"
```
...
header:
  position: hamburger
  css_class:
    hamburger: navbar-dark bg-dark navbar-expand-lg
```
