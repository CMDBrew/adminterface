...
This will copy the following files to your application inside `config/config/active_admin_bootstrap/NAMESPACE`. See [Configuration](/docs/start/configuration) for usage guides and options.
  - `components.yml`
  - `css_classes.yml`
