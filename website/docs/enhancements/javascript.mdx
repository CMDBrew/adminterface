...
### ConfirmDialog
Adminterface uses ConfirmDialog for batch action and delete confirmations. See the guides on [BatchActions](/docs/enhancements/index#batch-actions) and [ConfirmDialog](/docs/enhancements/components#confirm-dialog) for more information.
...
Here is a basic example of how you can add a custom input to the Adminterface frontend.
```javascript
// Import the input you want to extend from
import { BaseInput } from '@cmdbrew/adminterface'

// Define your custom input
class CustomStringInput extends BaseInput {
...
### InputCounter
Adminterface uses InputCounter for text inputs. See the guides on [Customizing the Form](/docs/enhancements/form#text) for more information.
