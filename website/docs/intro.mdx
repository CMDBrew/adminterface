...
# Introduction
Adminterface is an add-on for [ActiveAdmin], and it brings the best parts of [ActiveAdmin] and [Bootstrap] into your project.
...
## License
Adminterface is free to use for non-commercial purposes and with a yearly subscription for commercial purposes. See [our Terms of Service in full text][Terms of Service] for more information.

:::tip
Building a commercial project for yourself or for a client? [Get a license](/pricing). We appreciate your support!
:::
