...
<div className={styles.section}>
  <div className="container">
    ...
    <p className="hero__subtitle">Every pricing plan will always include all features. There are absolutely no functionality differences with ActiveAdminBootstrap's pricing plan.</p>
  </div>
</div>
