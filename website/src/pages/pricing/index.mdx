...
<div className={styles.section}>
  <div className="container">
    ...
    <p className="hero__subtitle">Every pricing plan will always include all features. There are absolutely no functionality differences with Adminterface's pricing plan.</p>
  </div>
</div>
...
<div className={styles.section}>
  <div className="container">
    ...
    <details className="plain">
      <summary>
        <h2 className={styles.question}>What are the requirements to use Adminterface?</h2>
      </summary>
      <div>
    ...
    <details className="plain">
      <summary>
        <h2 className={styles.question}>Can Adminterface be integrated into existing applications?</h2>
      </summary>
      <div>
    ...
    <details className="plain">
      <summary>
        <h2 className={styles.question}>How does Adminterface's license enforcement work?</h2>
      </summary>
      <div>
